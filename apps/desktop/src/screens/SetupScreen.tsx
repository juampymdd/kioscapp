...
export default function SetupScreen({ onComplete }: Props) {
  ...
  async function guardar() {
    ...
    try {
      ...
      await store.setConfig('backend_url', backendUrl.trim())
      ...
      <div className="w-full max-w-md bg-slate-900 rounded-2xl border border-slate-800 p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1 text-center">
            Completá los datos de este local para comenzar
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            />
            <p className="text-slate-500 text-xs mt-1">
              Opcional. Sin esto las ventas se guardan solo localmente.
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-slate-500 text-xs mt-1">
              Debe coincidir con <code className="text-slate-400">SYNC_SECRET</code> del backend.
            </p>
          </div>
          ...
          <button
            onClick={guardar}
            disabled={guardando || !localId.trim()}
